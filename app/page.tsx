        ...
        <I18nextProvider i18n={i18}>
          <main className={styles.main}>
            ...
            <div className={styles.description}>
              <p>{t("mainBlock.ESGDescriptionFirst")}</p>
              <p>{t("mainBlock.ESGDescriptionSecond")}</p>
            </div>
            ...
            <div className={styles.coinWrapper}>
              ...
              <div className={styles.rightItems}>
                ...
                <Button type="filledLight">
                  {t("killowattCoinInfo.aboutKWBtn")}
                </Button>
              </div>
            </div>
            <div className={styles.idoWrapper}>
              <div className={styles.leftContainerIDO}>
                <Button type="filledLight">
                  {t("IDOInfo.participateInIDO")}
                </Button>
              </div>
              <div className={styles.rightContainerIDO}>
                <p className={styles.titleIDO}>IDO</p>
                <p className={styles.descriptionIDO}>
                  <span>IDO</span> – {t("IDOInfo.this")}{" "}
                  <span>{t("IDOInfo.smartContract")}</span>,{" "}
                  {t("IDOInfo.IDODescription")}
                </p>
              </div>
            </div>
            ...
            <div className={styles.stakingWrapper}>
              <div className={styles.stakingTitle}>
                ...
                <ul>
                  <p>
                    <span>{t("staking.subheading")}</span>
                  </p>
                  <li>
            ...
            <div className={styles.stakingCardsWrapper}>
              <div className={styles.card}>
                <div className={styles.cardContent}>
                  ...
                  <p>{t("cardsStaking.descriptionFirstCard")}</p>
                </div>
                <div className={styles.cardButtons}>
                  <Button type="filledDark">
                    {t("cardsStaking.buyKWBtn")}
                  </Button>
                  <Button type="filledDark">
                    {t("cardsStaking.makeDepositBtn")}
                  </Button>
                </div>
              </div>
              <div className={styles.card}>
                <div className={styles.cardContent}>
                  ...
                  <p>{t("cardsStaking.descriptionSecondCard")}</p>
                </div>
                <div className={styles.cardButtons}>
                  <Button type="filledDark">
                    {t("cardsStaking.buyLPBtn")}
                  </Button>
                  <Button type="filledDark">
                    {t("cardsStaking.makeDepositBtn")}
                  </Button>
